...
export function MusicPlayer() {
  ...
  usePanelTilt(panelRef, {
    enabled: !playerHandedOff,
    maxRotation: isMinimized ? 10 : 7,
    perspective: isMinimized ? 1200 : 1500,
    lerpFactor: 0.16,
    easeOutDuration: 180,
  });
  ...
  return (
    <motion.aside
      ...
      style={{
        ...
        filter: `saturate(${(1.03 - mergeProgress * 0.05).toFixed(3)})`,
      }}
    ...
    >
      <div
        ref={panelRef}
        className={cn(
          "relative isolate h-full w-full overflow-hidden bg-[rgba(10,10,14,0.58)] shadow-[0_18px_60px_rgba(5,5,8,0.3)] backdrop-blur-[16px]",
          isMinimized
            ? "rounded-[28px] p-3 sm:rounded-[30px]"
      ...
      >
        <div
          ...
          className={cn(
            ...
            isMinimized
              ? "shadow-[inset_0_1px_0_rgba(255,255,255,0.12),inset_0_-22px_36px_rgba(0,0,0,0.2)]"
              : "shadow-[inset_0_1px_0_rgba(255,255,255,0.12),inset_0_-28px_48px_rgba(0,0,0,0.24)]",
          )}
          style={{
            background: `linear-gradient(145deg, rgba(255,255,255,${paneSheenOpacity.toFixed(3)}) 0%, rgba(255,255,255,0.032) 16%, rgba(255,255,255,0.01) 38%, rgba(6,6,9,0.12) 100%)`,
          }}
        />
        <div
          aria-hidden="true"
          ...
          style={{
            ...
            background: `radial-gradient(circle at top left, rgba(255,255,255,${paneSheenOpacity.toFixed(3)}), transparent 34%), radial-gradient(circle at 80% 18%, rgba(var(--accent-rgb),${paneGlowOpacity.toFixed(3)}), transparent 38%), linear-gradient(180deg, rgba(255,255,255,0.022), rgba(255,255,255,0.008) 24%, rgba(8,8,12,0.04) 100%)`,
          }}
        />
        <div
          aria-hidden="true"
          ...
          style={{
            opacity: 0.18 - mergeProgress * 0.04,
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[10px] uppercase tracking-[0.28em] text-ink/56">Powered by YouTube</p>
              ...
              <div className="mt-3 space-y-2">
                <div className="flex items-center justify-between text-[10px] uppercase tracking-[0.22em] text-ink/52">
