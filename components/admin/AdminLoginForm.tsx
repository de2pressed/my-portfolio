  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-8 pt-20 lg:grid-cols-[1.05fr_0.95fr]">
        <motion.aside
          className="relative overflow-hidden rounded-[44px] border border-white/10 bg-[rgba(10,10,14,0.4)] p-8 shadow-[0_30px_100px_rgba(52,36,22,0.16)] backdrop-blur-2xl md:p-10"
          ...
          <div className="relative space-y-8">
            ...
            <div className="grid gap-3">
              {[
                ...
                <div
                  className="flex items-center gap-3 rounded-[22px] border border-white/10 bg-[rgba(10,10,14,0.36)] px-4 py-3 text-sm text-ink/72"
                  key={line}
                >
        ...
        <motion.section
          className={`glass-panel relative overflow-hidden rounded-[44px] border border-white/10 bg-[rgba(10,10,14,0.4)] p-6 shadow-[0_34px_120px_rgba(52,36,22,0.2)] backdrop-blur-2xl md:p-8 ${
