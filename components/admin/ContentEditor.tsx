  ...
  return (
    <section className="section-card">
      ...
      <div className="grid gap-4">
        {items.map((entry) => (
          <article className="rounded-[24px] border border-white/10 bg-[rgba(10,10,14,0.34)] p-4" key={entry.id}>
            ...
            <textarea
              className="min-h-[140px] w-full rounded-[20px] border border-white/10 bg-[rgba(10,10,14,0.36)] px-4 py-3 text-sm text-ink outline-none"
