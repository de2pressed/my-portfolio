...
export function VersionBadge() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-4 left-4 z-40 rounded-full border border-white/10 bg-[rgba(10,10,14,0.5)] px-3 py-1.5 text-xs uppercase tracking-[0.28em] text-ink/78 shadow-glass backdrop-blur-xl">
      {version}
    </div>
  );
}
